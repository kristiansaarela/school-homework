Kõik sisestaud käsud ja tulemused kopeeri sellele töölehele.

Käivita oma andmebaasis fail kool.sql


1. Millistes ainetes pole õpilased ühtegi hinnet saanud?
...
2. Väljasta nende õpilaste ees- ja perenimi, kes on saanud hindeid.
...
4. Väljasta hinnatud ained, hinded ja õpetajad, kes on ainet hinnanud.
...
5. Leia keskimine hinne kõikidest hinnetest.
...
6. Leia iga aine keskmine hinne. Väljasta aine nimetus ja keskmine hinne.
...
7. Koolis hakatakse hindama 5-pallise skaala asemel 10 pallisel skaalal. Väljasta ained ja uued hinded, kui on teada, et hinded muutuvad järgmiselt (1->2, 2->4, 3->6, 4->8 ja 5->10).



8. Loo vaade, milles näidatakse neid õpilasi, kes on saanud mingis aines hinde. Lisaks õpilase nimele, kuva ka aine nimetus, hinne ja õpetaja, kes hindas teadmisi aines.
...
9. Leia õpilaste sünniajad isikukoodist. Väljasta õpilase ees- ja perenimi ühes veerus ja õpilase sünniaeg kujul nt 27.09.2010
...
11. Leia, mitu õpilast õpib igas grupis?
...
12. Leia mitu tüdrukut ja mitu poissi õpib igas grupis.
